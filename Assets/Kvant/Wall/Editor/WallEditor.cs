...
namespace Kvant
{
    ...
    public class WallEditor : Editor
    {
        ...
        SerializedProperty _noiseOctave0;
        SerializedProperty _noiseOctave1;
        SerializedProperty _noiseOctave2;
        ...
        static GUIContent _textNoise         = new GUIContent("Noise");
        ...
        void OnEnable()
        {
            ...
            _noiseOctave0  = serializedObject.FindProperty("_noiseOctave0");
            _noiseOctave1  = serializedObject.FindProperty("_noiseOctave1");
            _noiseOctave2  = serializedObject.FindProperty("_noiseOctave2");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(_noiseOctave0);
            EditorGUILayout.PropertyField(_noiseOctave1);
            EditorGUILayout.PropertyField(_noiseOctave2);
