...
namespace Kvant
{
    ...
    public partial class Wall : MonoBehaviour
    {
        ...
        float _noiseOctave0  = 1;
        public float NoiseOctave0 {
            get { return _noiseOctave0; }
            set { _noiseOctave0 = value; }
        }
        [SerializeField]
        float _noiseOctave1  = 0;
        public float NoiseOctave1 {
            get { return _noiseOctave1; }
            set { _noiseOctave1 = value; }
        }
        [SerializeField]
        float _noiseOctave2   = 0;
        public float NoiseOctave2 {
            get { return _noiseOctave2; }
            set { _noiseOctave2 = value; }
        }
        ...
        void UpdateKernelShader()
        {
            ...
            var octaves = new Vector4(
                _noiseOctave0, _noiseOctave1, _noiseOctave2, 0);

            m.SetVector("_NoiseOctaves", octaves);
